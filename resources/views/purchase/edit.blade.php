                        ...
                        <div class="panel panel-inverse" style="height: 300px">
                            ...
                            <div class="panel-body">
                                <div id="userResurts" class="inbox-widget nicescroll mx-box">
                                    <form action="{{ route('admin.purchase.update', ['id' => $data[0]->purchase_code]) }}"
                                        method="POST">
                                        @csrf
                                                ...
                                                <td>
                                                    <button class="btn btn-danger waves-effect waves-light"
                                                        style="margin: 4px;" id="removeItem"><a
                                                            href="{{ route('admin.purchase.item.delete', ['id' => $item->item_id]) }}"
                                                    ...
                                                    <form id="delete-form-{{ $item->item_id }}"
                                                        action="{{ route('admin.purchase.item.delete', ['id' => $item->item_id]) }}"
