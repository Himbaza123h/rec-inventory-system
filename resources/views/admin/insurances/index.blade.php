    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="pull-left page-title"><b>INSURANCES</b></h4>
                        ...
                        <div id="userdiv">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="panel-title"> New Insurance</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form action="{{ route('admin.insurance.store') }}" method="POST">
                                        @csrf
                                        Insurance name<br /> <br />
                                        <input type="text" name="insurance_name" id="" class="form-control"
                                            placeholder="Insurance  Name"><br />
                                        <button type="submit" class="btn btn-success"><i class="md md-add"></i>Add
                                            new</button>
                                    </form>
                                </div>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="btn btn-danger rounded p-2 m-2">
                                                            <a href="{{ route('admin.insurance.delete', ['id' => $item->id]) }}"
                                                        ...
                                                        <form id="delete-form-{{ $item->id }}"
                                                            action="{{ route('admin.insurance.delete', ['id' => $item->id]) }}"
