                    ...
                    <div class="panel panel-inverse" style="height: 680px">
                        ...
                        <div class="panel-body">
                            <div id="userResurts" class="inbox-widget nicescroll mx-box">
                                <form action="{{ route('seller.checkout.update', ['id' => $data[0]->sale_code]) }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2" style="margin-top: 6px">
                                            <label for=""></label>
                                            <a href="{{ route('seller.customers.index') }}" class="btn btn-primary waves-effect waves-light">New
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" id="ticket_moderateur" class="form-control" placeholder="0" disabled />
                                        </div>
                                    </div><br>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label for="ticket_moderateur">TopUp</label><br>
                                            <input type="text" id="amount_to_pay" class="form-control" placeholder="0" disabled />
                                        </div>
                                    </div><br>
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <button type="submit" class="btn btn-success waves-effect waves-light" id="purchase_item">CONFIRM <i class="ion-ios7-cart-outline"></i></button>
                                </form>
                            ...
                            <table border="1" width="100%">
                                    ...
                                    <th colspan="8">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="pull-right">
                                                <img src="{{ asset('assets/images/electric.jpg') }}" height="100" width="200" alt="LOGO">
                                            </div>
                                        </div>
                                    </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->lens?->power?->sph }}-{{ $item->lens?->power?->syl }}-{{ $item->lens?->power?->axis }}-{{ $item->lens?->power?->add_ }}</td>
                                        @endif
                                        <td>{{ $item->qty }}</td>
                                        <td>{{ $item->price }}</td>
...
<script>
    $(document).ready(function() {
        ...
        function updateTicketModerateur() {
            ...
            const totalCovered = Array.from(coveredElements).reduce((acc, td) => acc + parseFloat($(td).text()), 0);
